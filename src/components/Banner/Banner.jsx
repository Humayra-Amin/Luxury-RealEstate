        ...
        <div>
            <div className="carousel w-full">
                ...
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    {/* <div className='absolute ml-[90px] mt-[100px] md:ml-[300px] md:mt-[320px] lg:ml-[650px] lg:mt-[400px]'>
                ...
                <div className='absolute ml-[90px] mt-[110px] md:ml-[300px] md:mt-[320px] lg:ml-[650px] lg:mt-[400px]'>
                    <button className='btn btn-primary'>View properties</button>
                </div>
