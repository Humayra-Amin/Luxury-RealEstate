        ...
        <div className="font-roboto">
            ...
            <div className="container mx-auto w-10/12 lg:w-4/5 text-center my-10 text-xl">
                ...
                <div className="card lg:card-side bg-base-100 shadow-xl mt-14">
                    <div className="card-body text-start">
                        <h2 className="text-2xl font-bold text-center">Our Mission and Vision</h2>
                ...
                <div className="card lg:card-side bg-base-100 shadow-xl mt-14">
                    <figure><img src={pics1} alt="Album" className="h-[200px] md:h-[500px] lg:w-[2000px] lg:h-[500px]" /></figure>
                    <div className="card-body text-start">
